...
const { create, view, details, update, changeStatus, destroy } = require('../../Controller/Admin/whychooseus.controller');
const router = express.Router();
const multer = require('multer')
const upload = multer({ dest: 'uploads/whychooseus' })
...
module.exports = (server) => {
    ...
    server.use('/api/admin/whychooseus', router);
}